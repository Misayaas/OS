        ...
        for (int i = 1; i <= 20; i++) {
            ...
            for (int j = NR_TASKS + 1; j < NR_PROCS + NR_TASKS; j++) {
                ...
                if(num < 10){
                    ...
                    printf("\06%c%c ", num / 10 + '0', num % 10 + '0');
                }
            }
            printf("\n");
            mysleep(TIMESLICE);
